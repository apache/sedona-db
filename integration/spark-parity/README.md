...
One test file per function, named `test_rs_<function>.py` or
`test_st_<function>.py` — parity coverage for a function lands in its own file,
not appended to a neighbor's.
