...
GeoTIFF files can also be queried directly by file path (e.g., `SELECT * FROM 'path/to/raster.tif'`).

## Examples

```sql
SELECT path, x, y
FROM rs_geotiff_tiles('https://download.osgeo.org/geotiff/samples/gdal_eg/cea.tif');
```
