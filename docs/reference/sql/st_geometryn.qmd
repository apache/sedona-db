...
`n` is 0-based, matching Sedona Spark: `0` returns the first geometry. Note
that PostGIS counts from 1.

A geometry that is not a collection is returned as-is for `n = 0`.
