...
description: Computes the statistics of geometries for the input geometry or geography.
kernels:
  - returns: struct
    args: [geometry]
  - returns: struct
...
- `minx`, `miny`, `maxx`, `maxy`: Minimum bounding rectangle (envelope). For geography, this represents geographical bounds such that minx may be greater than miny where this represents more compact bounds (e.g., a small feature crossing the antimeridian).
- `mean_size_in_bytes`
