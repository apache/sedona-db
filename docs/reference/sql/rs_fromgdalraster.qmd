...
raster with all band data materialised inline — the inverse of `RS_AsGeoTiff`,
and the binary counterpart of [`RS_FromPath`](rs_frompath.qmd) (which references
a file on disk as an out-db raster instead). A `NULL` input yields a `NULL`
raster.
