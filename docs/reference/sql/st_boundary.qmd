...
title: ST_Boundary
description: Returns the closure of the combinatorial boundary of this Geometry or Geography.
kernels:
  - returns: geometry
    args: [geometry]
  - returns: geography
...
```sql
SELECT ST_Boundary(ST_GeogFromWKT('POLYGON ((0 0, 1 0, 1 1, 0 1, 0 0))'));
```
