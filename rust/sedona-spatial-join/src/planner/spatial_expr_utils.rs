...
<<<<<<<< HEAD:rust/sedona-query-planner/src/spatial_expr_utils.rs
========
...
>>>>>>>> f832715f (move easy utilities to sedona-spatial-join-common):rust/sedona-spatial-join-common/src/spatial_expr_utils.rs
