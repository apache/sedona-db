...
//! Benchmarks for RS_ZonalStats and RS_ZonalStatsAll UDFs
//!
//! RS_ZonalStats computes statistics for pixels within a geometry.
//! RS_ZonalStatsAll computes all statistics at once.
//!
...
fn bench_rs_zonal_stats_placeholder(c: &mut Criterion) {
    let mut group = c.benchmark_group("rs_zonal_stats");
...
criterion_group!(benches, bench_rs_zonal_stats_placeholder);
