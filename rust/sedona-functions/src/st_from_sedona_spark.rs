...
mod tests {
    ...
    #[test]
    fn test_st_from_sedona_spark_point_1() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/point.sedona"));
    ...
    #[test]
    fn test_st_from_sedona_spark_linestring_1() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/linestring.sedona"));
        let tester = get_tester();
        ...
        tester.assert_scalar_result_equals(result, "LINESTRING (0 0, 1 1, 2 2)");
    }

    #[test]
    fn test_multipoint_geometry() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/multipoint.sedona"));
        let tester = get_tester();
        ...
        tester.assert_scalar_result_equals(result, "MULTIPOINT((1 1), (2 2), (4 5))");
    }

    #[test]
    fn test_multilinestring_geometry() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/multilinestring.sedona"));
        let tester = get_tester();
        ...
        tester.assert_scalar_result_equals(result, "MULTILINESTRING((1 1, 2 2), (4 5, 6 7))");
    }

    #[test]
    fn test_polygon_geometry() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/polygon.sedona"));
        let tester = get_tester();
    ...
    fn test_multipolygon_geometry() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/multipolygon.sedona"));
        let tester = get_tester();
    ...
    #[test]
    fn test_geometrycollection_geometry() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/geometrycollection.sedona"));
        let tester = get_tester();
    ...
    #[test]
    fn test_complex_geometry_collection() {
        let binary_geometry =
            fixture_to_bytes(include_str!("fixtures/geometrycollectioncomplex.sedona"));
        let tester = get_tester();
    ...
    #[test]
    fn test_geometry_collection_in_geometry_collection() {
        let binary_geometry =
            fixture_to_bytes(include_str!("fixtures/nested_geometry_collection.sedona"));
        let tester = get_tester();

        let result = tester
            .invoke_scalar_scalar(
                binary_geometry,
                ScalarValue::Utf8(Some("EPSG:4326".to_string())),
            )
            .unwrap();
    ...
    fn test_empty_geometries() {
        let test_data = vec![
            (include_str!("fixtures/empty_point.sedona"), "POINT EMPTY"),
            (
                include_str!("fixtures/multipoint_empty.sedona"),
                "MULTIPOINT EMPTY",
            ),
            (
                include_str!("fixtures/empty_linestring.sedona"),
                "LINESTRING EMPTY",
            ),
            (
                include_str!("fixtures/empty_polygon.sedona"),
                "POLYGON EMPTY",
            ),
            (
                include_str!("fixtures/empty_multipolygon.sedona"),
                "MULTIPOLYGON EMPTY",
            ),
            (
                include_str!("fixtures/empty_multilinestring.sedona"),
                "MULTILINESTRING EMPTY",
            ),
            (
                include_str!("fixtures/empty_geometry_collection.sedona"),
        ...
        for (test_fixture, expected_wkt) in test_data {
            let binary_geometry = fixture_to_bytes(test_fixture);
    ...
    fn test_non_integer_coordinates() {
        let binary_geometry = fixture_to_bytes(include_str!("fixtures/point_float_coords.sedona"));
        let tester = get_tester();
