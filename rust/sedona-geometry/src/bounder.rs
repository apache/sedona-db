...
impl GeometryBounder {
    ...
    pub fn empty() -> Self {
        Self {
            ...
            z: Interval::empty(),
            m: Interval::empty(),
            geometry_types: GeometryTypeAndDimensionsSet::default(),
    ...
    fn update_geometry(
        ...
        self.geometry_types
            .insert(&GeometryTypeAndDimensions::try_from_geom(geom)?)?;
...
mod test {
    ...
    ) -> Result<GeometryBounder, SedonaGeometryError> {
