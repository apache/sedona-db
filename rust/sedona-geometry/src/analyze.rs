...
/// a specific [BoundingBox]. This allows geography types or precalculated bounds to be used.
pub fn analyze_wkb(geom: &Wkb, bbox: &BoundingBox) -> Result<GeometrySummary, SedonaGeometryError> {
