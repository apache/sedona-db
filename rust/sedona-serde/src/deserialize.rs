...
use crate::point::{deserialize_empty_point, deserialize_multipoint, deserialize_point};
use crate::polygon::{deserialize_empty_polygon, deserialize_multipolygon, deserialize_polygon};
...
pub fn deserialize_geometry<IN: ByteOrder, OUT: ByteOrder>(
    ...
    match wkb_type {
        ...
        5 => {
            let mut meta_data_reader = Cursor::new(bytes);
            deserialize_multilinestring::<IN, OUT>(
                builder,
                cursor,
